...
int main(int argc, char *argv[]) {
	...
	double m[11][2]={{1,0.098},{1.1,-0.043},{1.2,-0.201215},{1.3,-0.368834},{1.4,-0.535837},{1.5,-0.693},{1.6,-0.831723},{1.7,-0.945},{1.8,-1.024802},{1.9,-1.058003},{2,-1.053}};
	double h, derivada;
	int operador, grado, i=10,x;//filas - 1(el i se cambia en cada problema);
	h=m[1][0]-m[0][0];
	...
	printf("La derivada de grado %d en el punto x=%lf es: %lf", grado, m[x][0], derivada);
	return 0;
}
