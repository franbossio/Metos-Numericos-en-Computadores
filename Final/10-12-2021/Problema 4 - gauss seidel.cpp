...
void jacobi (double a[15][15] , double b[15], int filas);
void gaussSeidel (double a[15][15] , double b[15], int filas);
void relajacion (double a[15][15] , double b[15], int filas);
bool diagonalmenteDominante(double a[15][15], int filas);
