...
int main(int argc, char *argv[]) {
	double m[8][2] = {{0,1},{0.25,1.384},{0.5,1.849},{0.75,2.417},{1,3.118},{1.25,3.99},{1.5,5.082},{2,8.189}}; 
	int filas = 8; //poner aca la cantidad de filas de m. acordate que la cantidad de intervalos es filas-1
